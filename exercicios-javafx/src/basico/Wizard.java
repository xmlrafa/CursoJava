...
public class Wizard extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		janela.setTitle("Passo 1");
		janela.show();
		
	}
	
	private void criarPasso1() {
		Button proximoPasso = new Button("Avançar passo 2");
	...
	private void criarPasso2() {
		Button passoAnterior = new Button("Voltar passo 1");
		passoAnterior.setOnAction(e ->{
			janela.setScene(passo1);
			janela.setTitle("Passo 1");
		});
		Button proximoPasso = new Button("Avançar passo 3");
		proximoPasso.setOnAction(e -> {
	...
	private void criarPasso3() {
		Button passoAnterior = new Button("Voltar passo 2");
		passoAnterior.setOnAction(e ->{
			janela.setScene(passo2);
			janela.setTitle("Passo 2");
		});
		Button proximoPasso = new Button("Fechar");
		proximoPasso.setOnAction(e -> {
			System.exit(0);
		});
		HBox box = new HBox();
